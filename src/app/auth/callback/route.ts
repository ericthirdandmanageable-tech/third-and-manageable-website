  ...
  <body>
    ...
    <script>
      (function () {
        ...
        // First attempt quickly, then retry once in case Android tab is still settling.
        setTimeout(redirectToApp, 250);
        setTimeout(redirectToApp, 1000);
        if (isAndroid) {
          // Android Chrome fallback when custom-scheme handoff is delayed/blocked in Custom Tabs.
          setTimeout(function () {
