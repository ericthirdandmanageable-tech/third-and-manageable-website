    ...
    return (
        <section className="section-alt">
            <div className="max-w-6xl mx-auto" ref={ref}>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {brandTraits.map((item, index) => (
                        <motion.div
                            ...
                            className="group p-8 bg-[#040485] text-white rounded-2xl hover:scale-105 transition-transform duration-300 shadow-lg shadow-[#040485]/20"
                        >
                ...
                >
                    <div className="inline-block p-8 md:p-12 border-2 border-[#040485] rounded-2xl">
                        ...
                        <p className="text-sm font-medium tracking-widest uppercase text-[#040485]/50 mb-4">
                            The Mission
                        </p>
                        <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#040485]">
