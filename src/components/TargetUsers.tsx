...
export default function TargetUsers() {
    ...
    return (
        <section id="community" className="section bg-[#040485]">
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
                            ...
                            <span className="font-light text-white/50">In Transition</span>
                        </h2>
                        ...
                        <motion.a
                            href="#download"
                            className="inline-flex items-center gap-2 px-8 py-4 bg-white text-[#040485] font-semibold rounded-xl hover:bg-gray-100 transition-colors"
                    ...
                    <div className="space-y-4">
                        {userTraits.map((trait, index) => (
                            ...
                            >
                                <span className="flex-shrink-0 w-10 h-10 bg-white text-[#040485] rounded-full flex items-center justify-center">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
